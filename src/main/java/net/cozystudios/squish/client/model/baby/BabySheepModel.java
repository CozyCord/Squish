...
public class BabySheepModel extends SinglePartEntityModel<SheepEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("head",
                ModelPartBuilder.create().uv(0, 0).cuboid(-2.5F, -4.0F, -5.0F, 5.0F, 5.0F, 5.0F, new Dilation(0.0F)),
                ModelTransform.pivot(0.0F, 15.0F, -1.5F));
        ...
        modelPartData.addChild("right_front_leg",
                ModelPartBuilder.create().uv(8, 23).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, new Dilation(0.0F)),
                ModelTransform.pivot(-2.0F, 19.0F, -2.5F));

        modelPartData.addChild("right_hind_leg",
                ModelPartBuilder.create().uv(0, 23).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, new Dilation(0.0F)),
                ModelTransform.pivot(-2.0F, 19.0F, 2.5F));

        modelPartData.addChild("left_hind_leg",
                ModelPartBuilder.create().uv(24, 12).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, new Dilation(0.0F)),
                ModelTransform.pivot(2.0F, 19.0F, 2.5F));

        modelPartData.addChild("left_front_leg",
                ModelPartBuilder.create().uv(24, 5).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, new Dilation(0.0F)),
                ModelTransform.pivot(2.0F, 19.0F, -2.5F));
