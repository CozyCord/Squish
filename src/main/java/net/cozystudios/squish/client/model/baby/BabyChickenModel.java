...
public class BabyChickenModel extends SinglePartEntityModel<ChickenEntity> {
    ...
    public BabyChickenModel(ModelPart root) {
        ...
        this.beak = this.body.getChild("beak");
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData body = modelPartData.addChild("body",
                ModelPartBuilder.create().uv(0, 0).cuboid(-3.0F, -4.0F, -1.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)),
                ModelTransform.pivot(1.0F, 22.0F, -1.0F)
        );

        ModelPartData left_wing = body.addChild("left_wing", ModelPartBuilder.create(), ModelTransform.pivot(0.3F, -1.7F, 0.0F));
        left_wing.addChild("left_wing_r1",
                ModelPartBuilder.create().uv(8, 8).cuboid(0.0F, -2.0F, -1.0F, 1.0F, 2.0F, 0.0F, new Dilation(0.0F)),
                ModelTransform.of(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 0.7854F)
        );

        ModelPartData right_wing = body.addChild("right_wing", ModelPartBuilder.create(), ModelTransform.pivot(-3.0F, -1.0F, 0.0F));
        ...
        body.addChild("beak",
                ...
                ModelTransform.pivot(-1.0F, -1.0F, -1.0F)
        );

        modelPartData.addChild("rightleg",
                ModelPartBuilder.create()
                        .uv(0, 2).cuboid(0.0F, -2.0F, 0.0F, 1.0F, 2.0F, 0.0F, new Dilation(0.0F))
                        .uv(0, 0).cuboid(0.0F, 0.0F, -1.0F, 1.0F, 0.0F, 1.0F, new Dilation(0.0F)),
                ModelTransform.pivot(-1.5F, 24.0F, 0.0F)
        );

        modelPartData.addChild("leftleg",
                ModelPartBuilder.create()
                        .uv(0, 2).cuboid(0.0F, -2.0F, 0.0F, 1.0F, 2.0F, 0.0F, new Dilation(0.0F))
                        .uv(0, 1).cuboid(0.0F, 0.0F, -1.0F, 1.0F, 0.0F, 1.0F, new Dilation(0.0F)),
                ModelTransform.pivot(0.5F, 24.0F, 0.0F)
        );
