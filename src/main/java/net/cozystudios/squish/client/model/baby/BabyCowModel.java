...
public class BabyCowModel extends SinglePartEntityModel<CowEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head = modelPartData.addChild("head",
                ModelPartBuilder.create().uv(0, 18).cuboid(-5.0F, -6.0F, -1.0F, 6.0F, 6.0F, 5.0F, new Dilation(0.0F)),
                ModelTransform.pivot(2.0F, 15.0F, -9.0F));
        ...
        modelPartData.addChild("right_hind_leg",
                ModelPartBuilder.create().uv(22, 27).cuboid(-2.0F, -6.0F, -1.0F, 3.0F, 6.0F, 3.0F, new Dilation(0.0F)),
                ModelTransform.pivot(-2.0F, 24.0F, 3.0F));

        modelPartData.addChild("left_hind_leg",
                ModelPartBuilder.create().uv(34, 27).cuboid(-2.0F, -6.0F, -1.0F, 3.0F, 6.0F, 3.0F, new Dilation(0.0F)),
                ModelTransform.pivot(3.0F, 24.0F, 3.0F));

        modelPartData.addChild("left_front_leg",
                ModelPartBuilder.create().uv(34, 18).cuboid(-2.0F, -6.0F, -1.0F, 3.0F, 6.0F, 3.0F, new Dilation(0.0F)),
                ModelTransform.pivot(3.0F, 24.0F, -4.0F));

        modelPartData.addChild("right_front_leg",
                ModelPartBuilder.create().uv(22, 18).cuboid(-2.0F, -6.0F, -1.0F, 3.0F, 6.0F, 3.0F, new Dilation(0.0F)),
                ModelTransform.pivot(-2.0F, 24.0F, -4.0F));
