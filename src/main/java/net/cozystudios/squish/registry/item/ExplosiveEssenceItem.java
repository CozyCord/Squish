...
public class ExplosiveEssenceItem extends SquishBaseItem {
    public ExplosiveEssenceItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ExplosiveEssenceEntity entity = new ExplosiveEssenceEntity(world, user);
