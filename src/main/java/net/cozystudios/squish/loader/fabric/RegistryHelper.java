...
import net.cozystudios.squish.registry.item.SquishCandyItem;
import net.cozystudios.squish.registry.item.SquishEssenceItem;
import net.cozystudios.squish.registry.item.SquishGuidebookItem;
